...
const privacyTranslations = {
  en: {
    ...
    intro: "At HelpPoints.ch by Dana Rey, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our platform to connect with integration opportunities, including jobs and community events.",
    ...
    listItems: {
      ...
      personal3: "Skills, work experience, interests, and availability",
      ...
      use1: "Matching you with relevant integration opportunities (jobs, volunteering, events)",
      use2: "Connecting you with NGOs, community groups, and support services",
      ...
      sharing1: "To facilitate opportunity matching and support connections (only with your consent)",
  ...
  de: {
    ...
    listItems: {
      ...
      personal3: "Fähigkeiten, Berufserfahrung, Interessen und Verfügbarkeit",
      ...
      use1: "Vermittlung passender Integrationsmöglichkeiten (Jobs, Ehrenamt, Veranstaltungen)",
      use2: "Vermittlung zu NGOs, Community-Gruppen und Unterstützungsdiensten",
      ...
      sharing1: "Zur Erleichterung der Vermittlung von Angeboten und Unterstützungsverbindungen (nur mit Ihrer Einwilligung)",
  ...
  fr: {
    ...
    listItems: {
      ...
      personal3: "Compétences, expérience professionnelle, centres d’intérêt et disponibilité",
      ...
      use1: "Vous mettre en relation avec des opportunités d’intégration pertinentes (emplois, bénévolat, événements)",
      use2: "Vous connecter avec des ONG, des groupes communautaires et des services de soutien",
      ...
      sharing1: "Pour faciliter la mise en relation avec des opportunités et le soutien (uniquement avec votre consentement)",
  ...
  uk: {
    ...
    intro: "У HelpPoints.ch by Dana Rey ми зобов'язуємося захищати вашу конфіденційність. Ця Політика конфіденційності пояснює, як ми збираємо, використовуємо, розкриваємо та захищаємо вашу інформацію, коли ви використовуєте нашу платформу для зв'язку з можливостями інтеграції, зокрема з роботою та подіями спільноти.",
    ...
    listItems: {
      ...
      personal3: "Навички, трудовий досвід, інтереси та доступність",
      ...
      use1: "Підбір відповідних можливостей для інтеграції (робота, волонтерство, події)",
      use2: "Зв'язок з НГО, громадськими групами та службами підтримки",
      ...
      sharing1: "Для сприяння підбору можливостей та зв'язків підтримки (лише з вашою згодою)",
  ...
  "pt-BR": {
    ...
    intro: "Na HelpPoints.ch by Dana Rey, temos o compromisso de proteger sua privacidade. Esta Política de Privacidade explica como coletamos, usamos, divulgamos e protegemos suas informações quando você usa nossa plataforma para se conectar a oportunidades de integração, incluindo empregos e eventos comunitários.",
    ...
    listItems: {
      ...
      personal3: "Habilidades, experiência profissional, interesses e disponibilidade",
      ...
      use1: "Conectar você a oportunidades de integração relevantes (empregos, voluntariado, eventos)",
      use2: "Conectar você a ONGs, grupos comunitários e serviços de apoio",
      ...
      sharing1: "Para facilitar a combinação de oportunidades e conexões de apoio (somente com seu consentimento)",
